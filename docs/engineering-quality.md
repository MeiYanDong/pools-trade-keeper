...
Evidence status: implemented locally. The workflow is **defined but not active** until a remote is configured, the repository is pushed, and branch protection requires the check.
